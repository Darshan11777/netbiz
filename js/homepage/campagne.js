...
$(document).ready(function(){
	...
	$('.info-btn').click(function(){
		...
		gtag('event', 'view_item', {'send_to': ga_property, 'event_label' : 'P'+prelander+'. S2. Q1. Vorm keuken', 'event_category' : tag});
		...
		if(!geklikt){
			...
			if(huidig == 5){				
				$(".vragen-holder, #Form-sluit").fadeOut(function(){
					...
					gtag('event', 'view_item', {'send_to': ga_property, 'event_label' : 'P'+prelander+'. S'+eventnr+'. Form', 'event_category' : tag});
				...
				$("#"+vraag_id).fadeOut(function(){
					...
					gtag('event', 'view_item', {'send_to': ga_property, 'event_label' : 'P'+prelander+'. S'+eventnr+'. Q'+volgende+'. '+eventvraag, 'event_category' : tag});
